...
export const SpjWizard: React.FC<SpjWizardProps> = ({ user, spjId, onBack, onPreview }) => {
  ...
  /**
   * Hitung pajak otomatis Bend 26 — satu tombol per jenis pajak, karena tidak
   * semua pajak dipakai bersamaan. Setiap tombol hanya mengisi kolomnya sendiri.
   *   PHR = 8%  x angka terbilang
   *   PPh = 2%  x (angka terbilang - PHR)
   *   PPN = 11% x angka terbilang
   */
  const handleCalcTax = (kind: "phr" | "pph" | "ppn") => {
    const nominal = Number(formData.nominal || 0);
    if (!nominal) {
      alert("Isi Nominal terlebih dahulu, lalu klik tombol hitung pajaknya.");
      return;
    }
    const value =
      kind === "phr" ? calculatePhr(nominal) : kind === "pph" ? calculatePph(nominal) : calculatePpn(nominal);
    setFormData(prev => ({ ...prev, [kind]: value }));
    const label = kind === "phr" ? "PHR" : kind === "pph" ? "PPh" : "PPN";
    setSaveMessage(`${label} dihitung dari ${terbilangRupiah(nominal)}`);
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div className="border-t border-gray-200 dark:border-slate-700 pt-4">
                    ...
                    <p className="text-[10px] text-gray-400 mb-2 leading-relaxed">
                      Klik tombol hitung pada pajak yang dipakai — tidak semua pajak digunakan bersamaan.
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      {[
                        ...
                        <div key={key} className="block text-xs font-semibold text-gray-700 dark:text-slate-300">
                          ...
                          <button
                            type="button"
                            onClick={() => handleCalcTax(key as "phr" | "pph" | "ppn")}
                            title={`Hitung ${label} ${rate * 100}% secara otomatis dari angka terbilang`}
                            className="mt-1 w-full px-2 py-1.5 rounded-lg text-[10px] font-bold bg-[#32848D] hover:bg-[#276972] text-white inline-flex items-center justify-center gap-1 shadow-sm"
                          >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <SuggestionInput
                          ...
                          onChange={(v) => handleFormChange("penerima", v)}
                          storageKey="bend26.penerima"
              ...
              {activeDoc.documentTypeCode === "NOTULENSI_RAPAT" && (
                <div className="space-y-4 text-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-semibold text-gray-700 dark:text-slate-300 mb-1">Acara Rapat</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-gray-700 dark:text-slate-300 mb-1">Hari / Tanggal</label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="block text-xs font-bold text-[#32848D] mb-1">
                      Hasil Susunan Teks Keputusan Rapat
                    </label>
                    <textarea
                      value={
                ...
                <div className="space-y-4 text-sm">
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 p-4 rounded-xl space-y-2">
                    <label className="block text-xs font-bold text-blue-900 dark:text-blue-200">
                      Tautan Dokumen External Google Drive
                    </label>
                ...
                <div className="space-y-4 text-sm">
                  <div className="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 p-4 rounded-xl space-y-2">
                    <label className="block text-xs font-bold text-indigo-900 dark:text-indigo-200">
                      Tautan Surat Perintah Google Drive
                    </label>
                ...
                <div className="space-y-4 text-sm">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onKeyDown={(e) => handleNumberedEnter(e, "kesimpulanHasil")}
                  ...
                  <div>
                    ...
                    <SuggestionInput
                      ...
                      onChange={(v) => handleFormChange("pembuatLaporan", v)}
                      storageKey="lapangan.pembuatLaporan"
                ...
                <div className="space-y-4 text-sm">
                  <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 p-4 rounded-xl">
                    ...
                    <p className="text-xs text-teal-700 dark:text-teal-300">
                      Tempel tautan Google Drive foto kegiatan, lalu tekan Enter. Foto otomatis
                      ditarik dan dicetak pada lembar Lampiran Foto.
                    </p>
                  </div>
                              ...
                              <div className="bg-gray-50 dark:bg-slate-700/50 h-32 flex items-center justify-center overflow-hidden">
                                {info ? (
                                  <DriveImage
                                    ...
                                    fallbackClassName="p-2 text-gray-400 dark:text-slate-500"
                                  />
                                ) : (
